...
const VALID_EVENTS = new Set(['page_view', 'syllabus_modal_open', 'syllabus_unlock', 'enquiry_submit', 'course_gate_open', 'course_gate_unlock', 'whatsapp_click', 'whatsapp_gate_open', 'lab_script_view', 'lab_script_download']);
