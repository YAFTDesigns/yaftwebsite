  ...
  return (
    <>
      ...
      <div className={s.comboOffer}>
        ...
        <span className={s.comboOfferText}>Take <strong>Rhino3D for Architecture</strong> and <strong>Grasshopper for Architecture</strong> together for <strong>INR 40,000</strong>, personal training, all taxes included.</span>
      </div>
