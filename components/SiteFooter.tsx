    ...
    <footer>
      <div className="wrap">
        <div className="foot-bottom">
          ...
          <div className="fcol">
            <h4>Company</h4>
            <p>© 2026 YAFT Designs<br />All rights reserved<br /><a href="/sitemap.xml" style={{ color: 'var(--ink-soft)', fontFamily: 'var(--mono)', fontSize: 11 }}>Sitemap</a><br /><a href="/terms" style={{ color: 'var(--ink-soft)', fontFamily: 'var(--mono)', fontSize: 11 }}>Terms</a></p>
          </div>
        </div>
        <div style={{
