...
export default function TestimonialForm({ source }: { source?: string }) {
      ...
      {GOOGLE_REVIEW_URL && (
        <div className={styles.googleNudge}>
          ...
          <a href={GOOGLE_REVIEW_URL} target="_blank" rel="noopener noreferrer" className={styles.googleBtn}>
            <GoogleIcon className={styles.googleG} />
  ...
  return (
    <div className={styles.formWrap}>
      ...
      <div className={GOOGLE_REVIEW_URL ? styles.splitLayout : undefined}>
        ...
        {GOOGLE_REVIEW_URL && (
          <div className={styles.googleSidebar}>
            <div className={styles.googleSidebarInner}>
              <GoogleIcon className={styles.googleSidebarIcon} />
              <div className={styles.googleSidebarTitle}>Prefer Google?</div>
              <div className={styles.googleSidebarNote}>Share your experience directly on Google instead, takes 30 seconds.</div>
              <a href={GOOGLE_REVIEW_URL} target="_blank" rel="noopener noreferrer" className={styles.googleSidebarBtn}>
                Share on Google
              </a>
            </div>
          </div>
